...
return array(
	...
	"payment_endpoint" => "https://api.hubtel.com/v2/pos/onlinecheckout/items/initiate",
	"license_baseapi" => "https://apps.mobivs.com/invitasio/index.php/pluginapi/",
	"callback_baseapi" => admin_url("admin-ajax.php?action=hubtelpaymentcallback"),
	"merchantnum" => "",
	"logo" => "",
	"clientid" => "",
	"secret" => "",
